...
def parse_arguments(argv):
    ...
    parser.add_argument('--uaps_save', default='/data/yyt/project1/data/uaps/vgg19_norm10.pth',
                        help='training set directory')
    parser.add_argument('--batch_size', type=int, help='', default=500)
    parser.add_argument('--model_name', default='vgg19', help='')

    return parser.parse_args(argv)
# /home/yyt/Project1/data/val
# /data/ImageNet/imagnet_val
